...
export const getPresignedURL = createServerAction().input(z.object({ type: z.string(), size: z.number() })).output(z.object({ preSignedURL: z.string(), imageURL: z.string().url() })).handler(async ({ input }) => {
